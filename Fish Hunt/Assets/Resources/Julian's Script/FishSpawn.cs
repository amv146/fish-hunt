...
public class FishSpawn : MonoBehaviourPunCallbacks
{
    ...
    void Spawn()
    {
        ...
        {
            PhotonNetwork.Instantiate(Path.Combine("Julian's Prefabs", "GoldenFlyingFishPrefab"), pos, Quaternion.identity);
        }
        else if (PhotonNetwork.IsMasterClient)
        {
            PhotonNetwork.Instantiate(Path.Combine("Julian's Prefabs", "FlyingFishPrefab"), pos, Quaternion.identity);
        }
    }
